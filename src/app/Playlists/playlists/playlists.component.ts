...
import { Song } from 'src/app/model/playlist.model';
...
export class PlaylistsComponent {
  ...
  ngOnInit() {
    this.route.params.subscribe(params => {
      ...
      this.playlistService.getPlaylistSongs(data).subscribe((response: Song[]) => {
        this.playlistSongs = response;
        console.log(response);
        this.playlistService.getRecommendSong().subscribe((response: Song[]) => {
  ...
  getupdatedData() {
    if (this.playlistId) {
      this.playlistService.getPlaylistSongs(this.playlistId).subscribe((response: Song[]) => {
        this.playlistSongs = response;
        console.log(response);
      });
    }
